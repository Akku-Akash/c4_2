...
export const Orders = () => {
  ...
  const handlesort= (srt)=>{
     order.sort((a,b)=> a[srt]>b[srt] ? 1 : a[srt]<b[srt] ? -1: 0)
  }
  ...
  return (
    <div>
      <div>
        <div>
          <select className="controls" name="progress" id="progress" onChange={(e)=>{
        ...
        <table className="orders">
          ...
          <tbody>
            {order.map((e)=><tr className="orders-row" key={e.id}>
